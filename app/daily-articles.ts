export const dailyArticles = [
  ...
  },
  {
    ...
    category: "GAMING",
    date: "30 AGO 2026",
    dateIso: "2026-08-30T08:20:00-03:00",
    minutes: 9,
    title: "Gamescom 2026 repartió sus premios: CD Projekt y Sega salieron con el inventario lleno",
    dek: "Tres estatuillas para cada compañía, dos para Capcom y Ubisoft, y una feria que volvió a demostrar que el entusiasmo se gana con juegos visibles, no con promesas en humo 4K.",
    personalAngle: "Los premios de una feria nunca son una verdad revelada, pero sí una fotografía bastante entretenida del entusiasmo del momento. Yo los uso como radar: no para reservar a ciegas, sino para descubrir qué juegos consiguieron que la gente dejara de mirar el celular en un pabellón lleno de estímulos.",
    leadEyebrow: "EL MARCADOR DE COLONIA",
    leadTitle: "Dos ganadores grandes y una lista que invita a mirar más allá del tráiler",
    image: "https://eu-central-1-gamescom.graphassets.com/AMwDHZTUSMaIlRlMFLL7Qz/PssD8VBzTXq72TP0ISkN",
    imageAlt: "Escenario oficial de los gamescom awards 2026 durante la ceremonia de premiación",
    body: [
      "Gamescom 2026 cerró su competencia con dos nombres arriba del tablero: CD Projekt Red y Sega consiguieron tres premios cada una. Capcom y Ubisoft sumaron dos por lado, mientras Games Done Quick recibió el reconocimiento Heart of Gaming. Es una distribución más interesante que una coronación única porque muestra una feria con públicos y géneros tirando en distintas direcciones.",
      "No leo estos galardones como una garantía de calidad final. Muchos juegos se evalúan en condiciones controladas, con demos breves y el ruido de una feria alrededor. Lo que sí indican es qué propuestas lograron comunicar una identidad rápidamente, algo nada sencillo cuando al lado hay otra pantalla gigante pidiendo atención.",
      "CD Projekt conserva una capacidad enorme para convertir cada aparición en acontecimiento. Sega, por su parte, llegó con un catálogo más diverso: Persona 4 Revival, Crazy Taxi: World Tour, Total War: Warhammer 40,000, Alien Isolation 2 y otros proyectos mostraron que su estrategia no depende de una sola franquicia.",
      "Capcom y Ubisoft tampoco se fueron de Colonia con las manos vacías. Ese reparto me gusta porque evita la falsa idea de que existe un único videojuego capaz de resumir toda una feria. Gamescom funciona mejor como vidriera desordenada: un lugar donde un gigante puede dominar titulares y, a pocos metros, una idea más pequeña puede robarse la conversación.",
      "Mi reacción práctica es bastante menos épica: agrego nombres a la lista de seguimiento, miro partidas completas cuando aparecen y dejo la tarjeta guardada. Un premio previo al lanzamiento sirve para prestar atención; no reemplaza una reseña, una demo ni una política de devolución razonable."
    ],
    features: [
      {
        title: "PlayStation dejó veinte pistas para ordenar el radar",
        eyebrow: "LO QUE QUEDÓ DESPUÉS DEL SHOW",
        facts: "20 JUEGOS · DEMOS · FECHAS · PLATAFORMAS",
        image: "https://blog.playstation.com/tachyon/2026/08/4166a0def15c64a9deb61381b7fbd3ea6fae16d5.jpg?resize=1088%2C612&crop=0px%2C0px%2C1920px%2C1080px",
        alt: "Montaje oficial de juegos presentados para PlayStation durante Gamescom 2026",
        body: [
          "El resumen oficial de PlayStation reunió veinte anuncios y avances, desde Resonance: A Plague Tale Legacy hasta proyectos que todavía necesitan tiempo. Esa lista me resulta más útil que cualquier ranking aislado porque permite separar tres grupos: lo que ya tiene fecha, lo que mostró jugabilidad y lo que por ahora vive principalmente de una cinemática.",
          "Yo pondría primero en seguimiento aquello que enseñó sistemas funcionando y dejó una ventana concreta. El resto puede ser espectacular, pero permanece en la carpeta mental de ‘hablamos cuando haya controles en manos reales’. Gamescom genera deseo con facilidad; administrar ese deseo también forma parte del hobby."
        ]
      },
      {
        title: "Sega ganó porque llevó variedad, no una sola bala de plata",
        eyebrow: "SEIS JUEGOS JUGABLES",
        facts: "PERSONA · CRAZY TAXI · TOTAL WAR · ALIEN",
        image: "https://blog.playstation.com/tachyon/2026/08/34bf4534ea534ce0523a5327d77d978090c5942f-scaled.jpg",
        alt: "Arte oficial de los juegos de Sega presentados en Gamescom 2026",
        body: [
          "La presencia de Sega fue de esas que obligan a cambiar de género mental cada cinco minutos. RPG, conducción arcade, estrategia y terror compartieron espacio sin sentirse como sobras de una misma campaña. Para mí, esa amplitud explica mejor sus tres premios que cualquier discurso corporativo sobre sinergias.",
          "El desafío empieza ahora: transformar demos prometedoras en lanzamientos sólidos, con buen rendimiento y precios razonables. Me quedo con el radar encendido y sin reservas impulsivas. Si una feria hace bien su trabajo, uno sale con curiosidad; no necesariamente con la billetera vacía."
        ]
      }
    ],
    sources: [
      { name: "gamescom — ganadores oficiales 2026", url: "https://www.gamescom.global/en/gamescom-award-2026-the-winners-are" },
      { name: "PlayStation Blog — Opening Night Live", url: "https://blog.playstation.com/2026/08/25/gamescom-opening-night-live-highlights-19-games-coming-to-playstation/" },
      { name: "PlayStation Blog — novedades de Sega", url: "https://blog.playstation.com/2026/08/26/sega-gameplay-updates-persona-4-revival-crazy-taxi-world-tour-total-war-warhammer-40000-and-more/" }
    ]
  },
  {
    slug: "finanzas/g20-bessent-deuda-bonos-aranceles-asheville",
    category: "FINANZAS + CRIPTO",
    date: "30 AGO 2026",
    dateIso: "2026-08-30T08:10:00-03:00",
    minutes: 10,
    title: "El G20 llega a Asheville con USD 40 billones de deuda sentados en la mesa",
    dek: "Bessent quiere hablar de crecimiento y desequilibrios; el resto del mundo llega con preguntas sobre aranceles, bonos, energía e intervenciones. Una reunión económica con demasiados jefes finales al mismo tiempo.",
    personalAngle: "Cuando una cumbre promete ordenar la economía mundial, mi primera reacción es mirar qué problemas intentará dejar fuera de la foto. Esta vez no parece posible: deuda récord, rendimientos altos, petróleo, tarifas y monedas tensas entran juntos a la sala, aunque el comunicado final prefiera palabras más prolijas.",
    leadEyebrow: "DIPLOMACIA CON LA CALCULADORA ABIERTA",
    leadTitle: "Estados Unidos quiere marcar la agenda mientras sus bonos piden explicaciones",
    image: "https://828newsnow.com/wp-content/blogs.dir/282/files/2026/08/Treasury-secretary.jpg",
    imageAlt: "Scott Bessent ante periodistas durante la preparación de las reuniones financieras del G20",
    body: [
      "Los ministros de Finanzas y presidentes de bancos centrales del G20 se reúnen en Asheville entre el 31 de agosto y el 1 de septiembre. Scott Bessent quiere llevar la conversación hacia crecimiento, desequilibrios comerciales, regulación moderna, pagos transfronterizos y activos digitales. Sobre el papel parece una agenda ordenada; afuera de la carpeta, el contexto está bastante menos tranquilo.",
      "La deuda pública estadounidense superó los USD 40 billones el 19 de agosto y los rendimientos del bono a treinta años tocaron máximos de diecinueve años durante el mes, según Reuters. El Tesoro duplicó las recompras programadas de deuda de largo plazo hasta USD 4.000 millones por operación, una intervención que alivió temporalmente los rendimientos y abrió preguntas sobre la previsibilidad del mercado.",
      "A eso se suman nuevos aranceles, tensiones comerciales con socios del propio G20 y el impacto energético del conflicto con Irán. Estados Unidos quiere que otros países reduzcan vínculos económicos con Teherán, mientras varias delegaciones preferirán discutir el costo que esas decisiones ya trasladan a sus economías.",
      "Mi lectura es que la reunión importa menos por una frase final y más por el nivel de coordinación que consiga conservar. Si los bancos centrales y tesoros empiezan a enterarse de intervenciones relevantes por los diarios, el problema no es solamente diplomático: aumenta la incertidumbre con la que se valoran monedas, bonos y riesgo global.",
      "Para un inversor argentino, todo esto puede sentirse lejano hasta que se mueve el dólar, suben las tasas internacionales o cae el apetito por activos emergentes. No usaría una cumbre como señal de compra o venta, pero sí como recordatorio de que el precio del dinero global termina apareciendo en nuestra pantalla, aunque la reunión ocurra a miles de kilómetros."
    ],
    features: [
      {
        title: "Asheville es la sede; la reconstrucción también forma parte del mensaje",
        eyebrow: "POLÍTICA, TERRITORIO Y ECONOMÍA",
        facts: "29 AGO–1 SEP · MINISTROS · BANCOS CENTRALES",
        image: "https://wlos.com/resources/media/6ab94d5f-103c-416d-ad45-121fdf27dd10-jumbo16x9_VAVLHOTELS2NDMEETING.transfer_frame_4780.jpg?1584127945984",
        alt: "Vista de Asheville, Carolina del Norte, sede de las reuniones financieras del G20",
        body: [
          "El Tesoro eligió Asheville mientras la región continúa recuperándose del huracán Helene. La sede funciona así como escenario diplomático y como mensaje interno sobre revitalización. Esa capa política no invalida la reunión, pero conviene verla: las cumbres también cuentan historias sobre quién organiza y qué quiere mostrar.",
          "Los diputados financieros trabajaron durante el 29 y el 30; los ministros y banqueros centrales toman el relevo el 31 de agosto y el 1 de septiembre. Esperaría avances técnicos en pagos, deuda y fraude antes que una solución cinematográfica para el comercio mundial."
        ]
      },
      {
        title: "El folleto dice crecimiento; el mercado mira confianza",
        eyebrow: "LO QUE YO SEGUIRÍA",
        facts: "DEUDA · BONOS · YEN · ARANCELES",
        image: "https://home.treasury.gov/system/files/291/treasury-preview-1900x950.jpg",
        alt: "Fachada del Departamento del Tesoro de Estados Unidos utilizada en sus comunicados oficiales",
        body: [
          "No me quedaría solamente con el comunicado final. Miraría si hay lenguaje común sobre desequilibrios, si Estados Unidos explica mejor sus intervenciones y si los rendimientos largos responden con calma o con otra señal de desconfianza. El mercado de bonos suele ser menos fotogénico que una cumbre, pero también bastante menos diplomático.",
          "La conclusión provisional es incómoda y útil: ninguna potencia llega a esta mesa con el inventario limpio. Esto es información general, no asesoramiento financiero. Si algo merece seguimiento, es la coordinación real después de las fotos, no el adjetivo más optimista del documento."
        ]
      }
    ],
    sources: [
      { name: "828newsNOW — preparación del G20", url: "https://828newsnow.com/news/228822-asheville-gets-ready-for-g20-meetings-as-world-finance-leaders-head-to-wnc/" },
      { name: "WLOS — Asheville y el G20", url: "https://wlos.com/news/local/asheville-welcome-global-finance-leaders-upcoming-g20-meeting-business-central-bank-officials-helene-economy-international-conference" },
      { name: "U.S. Treasury — agenda oficial del G20", url: "https://home.treasury.gov/news/press-releases/sb0398" },
      { name: "Reuters — deuda, bonos y tensiones del G20", url: "https://www.reuters.com/world/china/us-treasurys-bessent-faces-g20-diplomacy-test-amid-tariffs-iran-war-bond-turmoil-2026-08-30/" }
    ]
  },
  {
    slug: "finanzas/xrp-ledger-computacion-cuantica-q-day-2028",
    category: "FINANZAS + CRIPTO",
    date: "30 AGO 2026",
    dateIso: "2026-08-30T08:00:00-03:00",
    minutes: 9,
    title: "XRP Ledger se prepara para el Q-Day: el riesgo cuántico dejó de ser ciencia ficción decorativa",
    dek: "Ripple trazó una migración en cuatro etapas hacia criptografía poscuántica con horizonte 2028. No significa que mañana despierten las máquinas y vacíen las wallets; significa que esperar al último día sería una pésima idea.",
    personalAngle: "La computación cuántica es perfecta para fabricar titulares apocalípticos: mezcla palabras difíciles, dinero digital y una amenaza sin fecha. Yo prefiero una lectura menos espectacular. Si una red tarda años en coordinar cambios, empezar antes de la emergencia no es paranoia; es mantenimiento preventivo.",
    leadEyebrow: "CRIPTOGRAFÍA ANTES DEL SUSTO",
    leadTitle: "Cuatro etapas para cambiar cerraduras sin apagar toda la red",
    image: "https://cdn.sanity.io/images/s3y3vcno/production/3fdb04bd3eb1c1413ad0d70e8d1e464ee4866ad9-1500x1000.jpg?auto=format&fit=crop&crop=focalpoint&w=1920&h=1080&q=75",
    imageAlt: "Representación de un procesador cuántico utilizada por CoinDesk en su informe sobre XRP Ledger",
    body: [
      "Ripple presentó una hoja de ruta de cuatro fases para preparar XRP Ledger frente a computadoras cuánticas capaces de comprometer los sistemas de firma actuales. El objetivo declarado es alcanzar preparación completa hacia 2028 mediante evaluación de vulnerabilidades, pruebas de algoritmos resistentes, convivencia temporal de ambos sistemas y una migración más amplia.",
      "La clave está en la palabra transición. Cambiar criptografía en una red pública no se parece a actualizar una contraseña. Hay validators, exchanges, custodios, hardware y millones de direcciones que deben coordinarse. Si cada actor se mueve a una velocidad distinta, la protección teórica puede chocar con una implementación fragmentada.",
      "El Q-Day describe el momento en que una computadora cuántica relevante pueda romper de forma práctica la criptografía que protege claves y firmas. No existe una fecha confirmada. Tampoco hay evidencia de que las wallets de XRP estén por quedar expuestas mañana. La hoja de ruta responde a un riesgo futuro que exige años de trabajo, no a una emergencia actual.",
      "Me parece saludable que el debate salga del laboratorio y entre en la ingeniería de red. El error sería convertirlo en propaganda alcista para XRP o en pánico vendedor. Una mejora de seguridad reduce un riesgo operativo; no resuelve adopción, liquidez, concentración, regulación ni valoración.",
      "Para quien guarda activos, la lección inmediata es bastante tradicional: seguir canales oficiales, mantener software actualizado y desconfiar de cualquiera que use la palabra cuántico para pedir una seed phrase. Las estafas van a llegar mucho antes que una máquina capaz de romper la criptografía."
    ],
    features: [
      {
        title: "La etapa híbrida será el puente más delicado",
        eyebrow: "DOS SISTEMAS AL MISMO TIEMPO",
        facts: "PRUEBAS · VALIDATORS · CUSTODIA · MIGRACIÓN",
        image: "https://s.yimg.com/lo/mysterio/api/282c28126fda13491b991bd4f50034fd3a0bbb03b6478141712338949edd273d/lightyear_networkapi/resizefill_w1200%3Bquality_80%3Bformat_webp/https%3A%2F%2Fmedia.zenfs.com%2Fen%2Fdlnews_702%2F43c079134a4303a98127dfe79de683f6",
        alt: "Ilustración editorial sobre Ripple y el riesgo de la computación cuántica",
        body: [
          "Antes de reemplazar por completo las firmas actuales, la propuesta contempla operar mecanismos clásicos y poscuánticos en paralelo. Eso permite medir costos y compatibilidad, pero también multiplica piezas móviles. El algoritmo puede ser sólido y aun así fallar una integración, una wallet o una política de recuperación.",
          "Yo seguiría especialmente las pruebas con validators y custodios. Una blockchain no queda protegida porque un documento nombre el algoritmo correcto; queda protegida cuando el ecosistema completo puede usarlo sin romper disponibilidad ni empujar a los usuarios hacia atajos inseguros."
        ]
      },
      {
        title: "No vendería por miedo ni compraría por la palabra cuántico",
        eyebrow: "MI REGLA PARA ESTA NOTICIA",
        facts: "RIESGO FUTURO · SIN FECHA · PLAN HASTA 2028",
        image: "https://www.nist.gov/sites/default/files/styles/social/public/images/2022/04/05/Crypto-rev1.png?itok=n-O8Vqo3",
        alt: "Diagrama oficial de NIST sobre algoritmos de criptografía poscuántica",
        body: [
          "La reacción sensata es pedir hitos verificables: código, pruebas, auditorías, adopción por validators y herramientas para usuarios. Un cronograma de 2028 es un compromiso útil, aunque todavía no es un resultado. Cada etapa debería poder medirse sin depender de frases tranquilizadoras.",
          "Esto no cambia mi valoración de XRP por sí solo. Sí mejora la calidad de la conversación técnica y obliga a otras redes a explicar su propio plan. Información general, no recomendación de inversión: frente a un riesgo incierto, prefiero ingeniería temprana y cero decisiones impulsivas."
        ]
      }
    ],
    sources: [
      { name: "CoinDesk — plan poscuántico de XRPL", url: "https://www.coindesk.com/tech/2026/08/28/ripple-is-preparing-xrp-ledger-for-quantum-computers-before-q-day-arrives" },
      { name: "Yahoo Finance — riesgo cuántico y Ripple", url: "https://finance.yahoo.com/markets/crypto/articles/ripple-haunted-spectre-quantum-computing-194854588.html" },
      { name: "NIST — criptografía poscuántica", url: "https://www.nist.gov/cybersecurity-and-privacy/what-post-quantum-cryptography" },
      { name: "Ripple — hoja de ruta oficial", url: "https://ripple.com/insights/post-quantum-readiness-on-the-xrp-ledger/" }
    ]
  },
  {
    slug: "tecnologia/openai-corta-modelos-cursor-spacex-noviembre",
    category: "TECNOLOGÍA + IA",
    date: "30 AGO 2026",
    dateIso: "2026-08-30T07:50:00-03:00",
    minutes: 9,
    title: "OpenAI le pone fecha de salida a Cursor: el divorcio con SpaceX llega el 12 de noviembre",
    dek: "La provisión directa de modelos terminará después de la compra de Cursor por SpaceX. El conflicto habla de Musk y Altman, sí, pero para los desarrolladores la pregunta útil es qué sigue funcionando al día siguiente.",
    personalAngle: "Las guerras de plataforma siempre parecen una serie protagonizada por CEOs hasta que una herramienta desaparece de nuestro flujo de trabajo. Ahí dejan de ser chisme corporativo. Yo miro esta ruptura pensando menos en quién ganó la discusión y más en cuántas dependencias invisibles tiene un desarrollador dentro de su editor.",
    leadEyebrow: "CAMBIO DE PROVEEDOR, CAMBIO DE PODER",
    leadTitle: "Cursor pierde el acceso directo, pero no queda convertido en un editor vacío",
    ...
    imageAlt: "Imagen oficial del anuncio de OpenAI sobre el fin de su acuerdo con Cursor",
    body: [
      "OpenAI notificó a SpaceX que pretende terminar el contrato mediante el cual provee modelos a Cursor. La fecha propuesta de corte es el 12 de noviembre de 2026, el plazo máximo permitido por el acuerdo después del cambio de control. La compañía también dijo que su próximo modelo Astra no llegará a Cursor por esa vía.",
      "La explicación pública es confianza contractual. OpenAI sostiene que no puede asegurar que SpaceX utilice su tecnología dentro de los términos acordados y cita experiencias anteriores con empresas controladas por Elon Musk. Cursor, sin embargo, no fue acusado de incumplir por sí mismo; quedó en medio de una disputa que cambió de escala con la adquisición.",
      "Para usuarios reales conviene bajar el volumen de la pelea. Cursor es una plataforma multimodelo y el acceso de OpenAI representaría una porción minoritaria de su tráfico, según declaraciones recogidas por medios especializados. Además, los desarrolladores podrían conservar rutas alternativas mediante sus propias claves de API y extensiones compatibles, aunque la experiencia y el costo pueden cambiar.",
      "Yo no migraría un equipo entero por un titular, pero tampoco esperaría hasta noviembre para probar alternativas. Un flujo de desarrollo importante merece una lista sencilla: qué modelo usa cada tarea, quién conserva el historial, cuánto cuesta el reemplazo y qué sucede si otro proveedor modifica sus condiciones.",
      "La historia más grande es la concentración. Un editor comprado por SpaceX, modelos controlados por laboratorios rivales y usuarios que construyen procesos encima de contratos que nunca ven. La inteligencia artificial puede hacer el código más flexible mientras su cadena comercial se vuelve más rígida."
    ],
    features: [
      {
        title: "El 12 de noviembre no debería ser una sorpresa en producción",
        eyebrow: "PLAN DE CONTINUIDAD",
        facts: "MODELOS · API · COSTOS · HISTORIAL",
        image: "https://media.thenextweb.com/2026/07/altman-white-house-openai-model-preview-agents.jpg",
        alt: "Sam Altman durante una presentación vinculada con nuevos modelos y agentes de OpenAI",
        body: [
          "Hay tiempo para medir antes del corte. Probaría las tareas habituales con proveedores alternativos, compararía calidad y latencia, y documentaría qué funciones dependen realmente de la integración directa. También revisaría políticas de retención y privacidad: cambiar el modelo no es solamente cambiar el nombre que aparece en un menú.",
          "La peor estrategia sería descubrir la dependencia el día del apagado. La segunda peor, mudarse por enojo sin comprobar nada. En herramientas de trabajo, la salida elegante se diseña cuando todo todavía funciona."
        ]
      },
      {
        title: "La novela Musk–Altman vende; la interoperabilidad importa más",
        eyebrow: "LO QUE QUEDA DESPUÉS DEL RUIDO",
        facts: "CAMBIO DE CONTROL · CONTRATOS · MULTIMODELO",
        image: "https://ptht05hbb1ssoooe.public.blob.vercel-storage.com/assets/og/opengraph-default.png",
        alt: "Identidad visual oficial de Cursor, el editor de programación adquirido por SpaceX",
        body: [
          "La rivalidad personal explica parte del contexto, pero no debería esconder el problema estructural. Una herramienta multimodelo es realmente resistente cuando cambiar de proveedor no destruye funciones, contexto ni economía. Si cada integración especial crea otro candado, la diversidad del menú puede ser apenas decorativa.",
          "Me quedo con una conclusión poco dramática: probar, exportar y documentar. Cursor tendrá que demostrar que la transición preserva el valor para sus usuarios; OpenAI tendrá que sostener rutas claras para quienes quieran seguir usando sus modelos. Nosotros no necesitamos elegir una camiseta para exigir ambas cosas."
        ]
      }
    ],
    sources: [
      { name: "OpenAI — decisión oficial sobre Cursor", url: "https://openai.com/index/our-decision-on-cursor-following-its-acquisition-by-spacex/" },
      { name: "The Next Web — impacto para desarrolladores", url: "https://thenextweb.com/news/openai-ends-cursor-contract-spacex-acquisition-eu-switching-rules" },
      { name: "Cursor — sitio oficial", url: "https://cursor.com/" },
      { name: "Reuters — ruptura tras la compra de SpaceX", url: "https://www.reuters.com/business/media-telecom/openai-end-partnership-with-spacexs-cursor-2026-08-29/" }
    ]
  },
  {
    slug: "tecnologia/carta-empresas-defensa-ciberataques-ia",
    category: "TECNOLOGÍA + IA",
    date: "30 AGO 2026",
    dateIso: "2026-08-30T07:40:00-03:00",
    minutes: 10,
    title: "Más de 100 empresas avisan que los ciberataques con IA van a escalar: la contraseña fuerte ya no alcanza",
    dek: "OpenAI, Anthropic, Microsoft, Google, Amazon y compañías de seguridad piden una ofensiva defensiva coordinada. La advertencia es seria; la carta todavía necesita convertirse en compromisos medibles.",
    personalAngle: "Las cartas abiertas tienen una habilidad especial para sonar urgentes sin decir quién paga la alarma. Esta me parece importante porque reúne a empresas que normalmente compiten, pero también la leo con una pregunta incómoda: ¿qué van a hacer mañana, además de pedir que todos hagamos más?",
    leadEyebrow: "UNA VENTANA QUE SE ESTÁ CERRANDO",
    leadTitle: "La IA abarata el ataque y obliga a tratar la defensa como una tarea de dirección",
    image: "https://images.ctfassets.net/kftzwdyauwt9/6imVXMcUcHNW3dFi3sWjCo/997611e54208bc274e1e1d6f0db21e31/collective-cyber-defense--seo-v001.png?w=1600&h=900&fit=fill",
    imageAlt: "Imagen oficial de la convocatoria colectiva para reforzar la ciberdefensa frente a la IA",
    body: [
      "Más de cien organizaciones firmaron una convocatoria para reforzar la defensa frente a ataques potenciados por inteligencia artificial. Entre los nombres aparecen OpenAI, Anthropic, Microsoft, Alphabet, Amazon, IBM, Cloudflare, CrowdStrike, Mastercard y Visa. El mensaje central es que los ataques serán más frecuentes y sofisticados durante los próximos meses.",
      "La carta pone hospitales, plantas de tratamiento de agua e infraestructura de internet como ejemplos de servicios expuestos. Pide que gobiernos y empresas prioricen la ciberdefensa al nivel de sus máximos responsables, compartan información y recursos, y aceleren programas de acceso confiable a modelos avanzados para defensores verificados.",
      "La amenaza no consiste en una IA mágica que decide convertirse en villana. Es más mundana y, por eso, más probable: herramientas que ayudan a encontrar vulnerabilidades, escribir código, traducir señuelos, automatizar reconocimiento y multiplicar intentos. Lo que antes exigía un equipo competente puede empezar a costar menos tiempo y dinero.",
      "Al mismo tiempo, la IA puede ayudar a defender: revisar código, clasificar alertas y acelerar respuestas. La carrera no es humanos contra máquinas, sino atacantes y defensores usando herramientas parecidas con incentivos muy distintos. Quien tenga procesos desordenados no va a resolverlos comprando un modelo más grande.",
      "Mi reserva con la carta es la ausencia inicial de plazos, presupuestos y obligaciones concretas para sus firmantes. Un llamado colectivo puede abrir una conversación; no sustituye parches, personal, simulacros ni transparencia cuando ocurre un incidente. La próxima noticia debería ser qué recursos puso cada actor sobre la mesa."
    ],
    features: [
      {
        title: "Para una pyme, el primer escudo sigue siendo bastante aburrido",
        eyebrow: "LO BÁSICO ANTES DEL MODELO FRONTERA",
        facts: "MFA · COPIAS · PARCHES · PERMISOS",
        image: "https://e3.365dm.com/26/08/1600x900/skynews-artificial-intelligence_7333218.jpg?20260827230854",
        alt: "Ilustración periodística sobre inteligencia artificial y ciberataques publicada por Sky News",
        body: [
          "Autenticación multifactor, copias de seguridad probadas, actualizaciones rápidas, permisos mínimos y un plan de respuesta siguen siendo menos vistosos que hablar de agentes autónomos. También siguen evitando una cantidad enorme de incidentes. La IA aumenta la velocidad del adversario; no vuelve inútiles los fundamentos.",
          "Yo empezaría por saber qué activos existen, quién accede y cuánto tardaría la organización en recuperarse. Recién después agregaría herramientas automáticas. Sin inventario ni responsables, una alerta más inteligente puede terminar siendo solamente otra notificación ignorada."
        ]
      },
      {
        title: "Los Five Eyes ya habían avisado: el riesgo cambia en meses",
        eyebrow: "NO ES UNA ALERTA AISLADA",
        facts: "LIDERAZGO · PREPARACIÓN · ADAPTACIÓN CONTINUA",
        image: "https://www.ncsc.gov.uk/sites/default/files/styles/uncropped_2xs/public/2026-05/5e-statement-ai-image.jpg?itok=bg2AZk9j",
        alt: "Imagen del comunicado de agencias Five Eyes sobre el cambio de riesgo cibernético por IA",
        body: [
          "Las agencias de ciberseguridad de Five Eyes publicaron en junio una advertencia parecida: las suposiciones de riesgo pueden quedar viejas en meses, no en años. Su recomendación pone responsabilidad y preparación en la dirección de cada organización, no solamente en el área técnica.",
          "Esa continuidad vuelve la carta más difícil de descartar como marketing. Ahora quiero ver compromisos verificables: herramientas defensivas disponibles, intercambio de indicadores, asistencia a infraestructura crítica y reportes públicos sobre resultados. La alarma ya sonó; toca medir quién se levantó de la silla."
        ]
      }
    ],
    sources: [
      { name: "OpenAI — convocatoria colectiva", url: "https://openai.com/collective-cyberdefense/" },
      { name: "Sky News — más de 100 firmantes", url: "https://news.sky.com/story/tech-companies-write-open-letter-calling-for-collective-action-against-ai-enabled-cyber-attacks-13577985" },
  ...
  {
    slug: "finanzas/bitcoin-mercado-criptomonedas-24-septiembre-2026",
    category: "FINANZAS + CRIPTO",
    date: "24 SEP 2026",
    dateIso: "2026-09-24T12:00:00-03:00",
    minutes: 8,
    title: "Bitcoin recupera impulso mientras el mercado cripto espera una señal más clara",
    dek: "La principal criptomoneda vuelve a concentrar volumen y atención institucional, aunque la volatilidad sigue siendo parte del precio.",
    personalAngle: "En cripto, una suba no es una promesa: es apenas una invitación a mirar mejor qué está comprando el mercado.",
    leadEyebrow: "CRIPTO Y LIQUIDEZ GLOBAL",
    leadTitle: "Bitcoin rebota, pero la pregunta importante sigue siendo quién está dispuesto a sostener el movimiento",
    image: "https://images.unsplash.com/photo-1518546305927-5a555bb7020d?auto=format&fit=crop&w=1600&q=85",
    imageAlt: "Representación visual de Bitcoin sobre una pantalla de mercado",
    imageCredit: "Unsplash",
    body: [
      "Bitcoin recuperó protagonismo este jueves después de varias ruedas de dudas. El rebote devolvió volumen al mercado y volvió a poner a la criptomoneda en las conversaciones de inversores que habían preferido esperar.",
      "La lectura más prudente es que el mercado está buscando dirección. Los flujos hacia productos de inversión, el dólar y las expectativas de tasas siguen pesando tanto como cualquier anuncio propio del ecosistema cripto.",
      "Cuando la liquidez global mejora, los activos de riesgo suelen respirar; cuando aparecen tasas más altas o aversión al riesgo, bitcoin vuelve a comportarse como un activo volátil. Esa contradicción no desapareció por una rueda positiva.",
      "Para quienes operan desde Argentina, además, hay que separar la cotización internacional del precio local, el tipo de cambio y las comisiones. Comparar sólo un número puede llevar a conclusiones equivocadas.",
      "Yo no entraría por FOMO. Miraría volumen, niveles de soporte, custodia y horizonte temporal antes de decidir. Esto es información general, no asesoramiento financiero."
    ],
    features: [
      { title: "El volumen importa más que el titular", eyebrow: "SEÑAL DE MERCADO", facts: "LIQUIDEZ · FLUJOS · VOLATILIDAD", image: "https://images.unsplash.com/photo-1621416894569-0f39ed31d247?auto=format&fit=crop&w=1400&q=85", alt: "Gráfico de cotización de criptomonedas en una pantalla", imageCredit: "Unsplash", body: ["Un rebote con volumen sostenido tiene una lectura distinta a una suba aislada.", "La confirmación suele aparecer después, no en el primer titular."] },
      { title: "La custodia también es parte de la inversión", eyebrow: "RIESGO OPERATIVO", facts: "BILLETERAS · CLAVES · SEGURIDAD", image: "https://images.unsplash.com/photo-1639762681057-408e52192e55?auto=format&fit=crop&w=1400&q=85", alt: "Moneda digital junto a un dispositivo de seguridad", imageCredit: "Unsplash", body: ["Comprar un activo digital no termina cuando aparece en la pantalla.", "La seguridad de la cuenta, las claves y la plataforma elegida también forman parte del resultado final."] }
    ],
    sources: [
      { name: "Bitcoin.org — documentación y funcionamiento", url: "https://bitcoin.org/en/how-it-works" },
      { name: "Coinbase Institutional — investigación de mercado", url: "https://www.coinbase.com/institutional/research-insights" },
      { name: "CME Group — futuros de Bitcoin", url: "https://www.cmegroup.com/markets/cryptocurrencies/bitcoin/bitcoin.html" }
    ]
  }
];
